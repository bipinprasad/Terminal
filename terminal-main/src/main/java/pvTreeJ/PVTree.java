...
//		m_hscroll.setVisible(true);
     ...
     *
     * @param startNode  the node to be searched.
     ...
     *
     * @param color a Color object for the foreground color
     */
    @Override
     ...
     *
     * @param newValue indicates whether node connecting lines should be displayed or not.
     */
     ...
     * display is enabled
     *
     * @param newValue indicates whether plus and minus buttons should be displayed or not.
     */
     ...
     *
     * @param newValue indicates whether images should be displayed or not.
     */
...
//		m_LinesPerPage = dim.height / m_LineHeight ;
    ...
    public int addImage(Image newImage) {
        ...
        try {
            m_MediaTracker.waitForID(size + 2);
...
//            return;
        ...
        } else if (event.getSource() == m_hscroll) {
            int id = event.getID();
            int type = event.getAdjustmentType();
            switch (type) {
                case AdjustmentEvent.UNIT_DECREMENT:
